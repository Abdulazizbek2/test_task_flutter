...
final _mockArticles = [
  Article(
    ...
    imageUrl:
        "https://i.ibb.co/Jk8FMMp/unsplash-Oqtaf-YT5k-Tw.jpg", // 'https://ibb.co/SvH799m',
...
To continue to enjoy ForestVPN without interruptions, please upgrade to our Premium version.''',
  ...
  Article(
    ...
    imageUrl:
        "https://i.ibb.co/VCb4zLk/unsplash-SYTO3xs06f-U-1.jpg", //'https://ibb.co/Wz7JMHR',
    description:
  ...
  Article(
    ...
    imageUrl:
        "https://i.ibb.co/DK9qHp0/daafc501e01c748fc88d582e7dd114de.jpg", // 'https://ibb.co/vz3t6Y0',
    description:
  ...
  Article(
    ...
    imageUrl:
        "https://i.ibb.co/3k12hXc/i-Phone-X-in-Hand-Mockup-2.jpg", // 'https://ibb.co/cxJ0T5Q',
    description:
